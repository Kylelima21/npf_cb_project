...
# write.csv(final_data, "email_alerts/test_data.csv", row.names = F)
# final_data <- read.csv("email_alerts/test_data.csv")
...
<div class = "new-box">
  ...
  <img src = "email_alerts/img/sacr.jpg" alt = "A something" class = "new-img">
